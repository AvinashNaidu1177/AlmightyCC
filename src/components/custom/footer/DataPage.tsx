...
function LocalStorageItem({ storageKey, value, onDelete }: LocalStorageItemProps) {
 ...
 return (
 <div className="flex flex-col bg-slate-800 p-3 rounded-lg shadow border border-gray-700 ">
 <div className="flex justify-between items-start">
 <div className="flex-1">
 <p className="font-medium text-gray-300 dark:text-gray-200 break-all">
 {storageKey}
 </p>
 <pre
 className={`text-sm text-gray-600 dark:text-gray-400 break-all mt-1 whitespace-pre-wrap font-mono transition-all duration-300 ease-in-out ${!showValue ? "blur-sm select-none" : ""
 }`}
 ...
 {isLarge && (
 <button
 className="mt-2 hover:cursor-pointer flex items-center gap-1 text-purple-600 dark:text-purple-400 text-xs font-medium hover:underline"
 ...
 className="hover:cursor-pointer text-purple-500 hover:text-purple-700 dark:hover:text-purple-400 midnight:hover:text-purple-400 transition cursor-pointer"
 >
