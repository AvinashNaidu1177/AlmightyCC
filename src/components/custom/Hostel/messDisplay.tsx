...
export default function MessDisplay({ hostelData, handleHostelDetailsFetch }) {
 ...
 <h2 className="text-md font-bold mb-2 text-center text-gray-400 dark:text-gray-300 ">
 ( Data taken from{" "}
 <a
 href="http://kaffeine.tech/unmessify"
 target="_blank"
 rel="noopener noreferrer"
 className="underline text-purple-600 dark:text-purple-400 midnight:text-purple-400"
 >
 Unmessify
 </a>{" "}
 )
 ...
 ? "bg-purple-600 text-white dark:bg-purple-500 midnight:bg-purple-700 dark:text-gray-100 "
 ...
 <div className="p-4 border rounded-2xl shadow bg-gray-900 dark:text-gray-200 ">
