...
export default function StatsCards({
 ...
 {/* Card 1 */}
 <div
 className={`${cardBase} bg-slate-800 `}
 onClick={() => setAttendancePercentageOrString(attendancePercentageOrString === "percentage" ? "str" : "percentage")}
 >
 <h2 className="text-lg font-semibold text-gray-600 dark:text-gray-300 ">Attendance</h2>
 ...
 >
 <h2 className="text-lg font-semibold text-gray-600 dark:text-gray-300 ">OD hours</h2>
 <p className="text-3xl font-bold text-gray-100 mt-2">
 {totalODHours}/40
 </p>
 </div>
 ...
 <div className="h-8 w-[1.5px] bg-gray-800 dark:bg-gray-600 midnight:bg-gray-700 rounded-full" />
 ...
 <p className="text-3xl font-bold text-gray-100 mt-2 select-none">
 ...
 >
 <h2 className="text-lg font-semibold text-gray-600 dark:text-gray-300 ">Credits Earned</h2>
 <p className="text-3xl font-bold text-gray-100 mt-2">
