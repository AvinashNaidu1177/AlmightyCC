...
function GradesDisplay({ data, handleFetchGrades, marksData, attendance }) {
 ...
 <button onClick={handleFetchGrades} className="mt-2 px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-medium transition-colors">
 ...
 <div className="relative h-3 rounded-full overflow-hidden bg-gray-800 dark:bg-gray-700">
 {!isComplete && (
 <div
 ...
 <div
 className={`absolute left-0 top-0 h-full ${isComplete ? "bg-purple-500" : "bg-purple-500 dark:bg-purple-600"
 }`}
 ...
 <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-[1px] bg-gray-800 dark:bg-gray-700 midnight:bg-gray-800 transform -translate-x-1/2" />
 ...
 <div className="relative h-2 rounded-full overflow-hidden bg-gray-800 dark:bg-gray-700">
 {!isComplete && (
 <div
 className="absolute left-0 top-0 h-full bg-yellow-400/60"
 style={{ width: `${progressWithOngoing}%` }}
 ...
 return (
 <div key={category}>
 <h5 className="text-sm font-semibold mb-2 text-gray-300 dark:text-gray-200 ">
 {category}
 </h5>
