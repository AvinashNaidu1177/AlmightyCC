...
export default function MoodleDisplay({ moodleData, handleFetchMoodle, setMoodleData, IDs }) {
 ...
 Moodle/LMS Data
 <button onClick={() => handleFetchMoodle()} className="mt-2 px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-medium transition-colors">
 ...
 {hiddenCount > 0 && (
 <div className="mt-6 flex items-center justify-center gap-3 text-sm text-gray-400 dark:text-gray-300">
