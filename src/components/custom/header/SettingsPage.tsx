...
export default function SettingsPage({ handleClose, currSemesterID, setCurrSemesterID, handleLogin, setIsReloading, handleLogOutRequest, username, password, setPassword, decimalValues, setDecimalValues, loadingScreen, setLoadingScreen }) {
 ...
 return (
 <div className="fixed inset-0 z-50 bg-gray-900 dark:bg-slate-900 bg-opacity-95 flex flex-col items-center justify-start overflow-y-auto p-6">
 <div className="w-full flex justify-between items-center mb-6 max-w-3xl">
 <h2 className="text-2xl font-semibold text-gray-300 dark:text-gray-200 ">
 Settings
 </h2>
 <Button
 variant="ghost"
 size="icon"
 onClick={handleClose}
 className="cursor-pointer hover:bg-[#111111] dark:hover:bg-slate-800 midnight:hover:bg-gray-900"
 >
 ...
 className="text-lg font-semibold text-gray-300 dark:text-gray-200 mb-2"
 >
 Select Semester
 </label>
 ...
 className="px-4 py-2 border border-gray-700 rounded-lg bg-slate-800 text-gray-300 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500"
 >
 ...
 <div className="w-full max-w-3xl flex items-center justify-between gap-3 border-t border-gray-700 py-4">
 <div className="flex flex-col flex-1">
 <label
 htmlFor="semesterSelect"
 className="text-lg font-semibold text-gray-300 dark:text-gray-200 mb-2"
 ...
 <span className="text-xs text-gray-300 dark:text-gray-600 midnight:text-gray-500">
 ...
 className="w-full px-4 py-2 mb-3 border border-gray-700
 ...
 className="w-full px-4 py-2 pr-12 border border-gray-700
 rounded-lg bg-slate-800 
 text-gray-300 dark:text-gray-200 
 focus:outline-none focus:ring-2 focus:ring-purple-500"
 />
 ...
 <div className="w-full max-w-3xl border-t border-gray-700 py-4 flex flex-col gap-4">
 <div className="flex items-center justify-between">
 <p className="text-md font-semibold text-gray-300 dark:text-gray-200 ">
