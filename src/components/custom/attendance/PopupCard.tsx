...
export default function PopupCard({ a, setExpandedIdx, dayCardsMap, analyzeCalendars, impDates, decimalValues }) {
 ...
 <div className="p-0">
 <div className="text-base font-semibold text-gray-300 dark:text-gray-100 ">
 {a.courseTitle}
 </div>
 ...
 />
 <p className="text-center text-xs font-semibold mt-1 text-gray-400 dark:text-gray-300 ">
 Attendance
 </p>
 </div>
 </div>
 ...
 impDates={impDates}
 />
 <div className="flex items-center justify-center gap-4 mt-3 text-xs font-medium text-gray-400 dark:text-gray-300 ">
...
function UpcomingClassesList({ classes, attendedClasses = 0, totalClasses = 0, isLab = false, impDates }) {
 ...
 bg-gray-900 dark:bg-slate-800 midnight:bg-gray-900 
 px-3 mt-2 py-2 rounded-md border border-gray-700 ">
 ...
 : isIgnored
 ? "bg-[#111111] dark:bg-gray-500 midnight:bg-gray-700 ..."
 : "bg-slate-900 midnight:bg-gray-950 ..."
 }`}
 >
 <span
