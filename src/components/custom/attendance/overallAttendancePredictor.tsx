...
export default function OverallAttendancePredictor({
 ...
 return (
 <div data-scrollable className="bg-gray-900 dark:bg-slate-800 p-5 rounded-2xl shadow-lg transition-all duration-300">
 ...
 : "bg-[#111111] dark:bg-slate-700 midnight:bg-gray-900 text-gray-400 dark:text-gray-200 hover:bg-purple-900/40 dark:hover:bg-purple-800 midnight:hover:bg-gray-800"
 }`}
 >
 {type === "CAT1"
 ? "Till CAT I"
 ...
 <p className="font-semibold text-gray-300 dark:text-gray-100 text-center">
 ...
 : "bg-slate-900 midnight:bg-gray-950 text-gray-400 dark:text-gray-200 hover:bg-purple-900/30 dark:hover:bg-purple-900/30 midnight:hover:bg-gray-800"
 }`}
 >
 ...
 <div className="flex items-center justify-center gap-4 mb-3 text-xs font-medium text-gray-400 dark:text-gray-300 ">
 ...
 <p className="font-semibold text-center text-purple-600 dark:text-purple-400 midnight:text-purple-400 mb-3">
 Predicted Overall Attendance ({mode}): {overallAvg}%
 </p>

 <div className="max-h-64 overflow-y-auto space-y-2 text-sm rounded-lg bg-slate-900 midnight:bg-gray-950 p-3 shadow-inner">
 {predictions.map((p, i) => (
 <div
 key={i}
 ...
 >
 <span
 className="text-gray-400 dark:text-gray-200 truncate max-w-[70%]"
 title={p.courseTitle}
 >
