...
export default function AttendanceTabs({ data, activeDay, setActiveDay, calendars, decimalValues }) {
 ...
 lidLabDate: findEventDate("lid for laboratory classes") || new Date(currentYear, 9, 24),
 ...
 <div className="relative w-[95%] max-w-4xl max-h-[95vh] overflow-y-auto bg-gray-900 dark:bg-slate-800 rounded-2xl shadow-2xl p-5">
 <Button
 variant="ghost"
 size="icon"
 onClick={() => setShowPredictor(false)}
 className="absolute top-3 right-3 hover:bg-[#111111] dark:hover:bg-slate-700 midnight:hover:bg-gray-900"
 >
 <X size={22} className="text-gray-400 dark:text-gray-200 " />
 </Button>
 ...
 {showTimetable && (
 <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex justify-center items-center">
 <div className="relative w-[95%] max-h-[95vh] overflow-y-auto bg-gray-900 dark:bg-slate-800 rounded-2xl shadow-2xl p-5">
 <Button
 variant="ghost"
 size="icon"
