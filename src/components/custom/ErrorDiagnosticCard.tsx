...
import { Terminal, Copy, CheckCircle2, ChevronRight, AlertCircle, RefreshCcw, Home } from "lucide-react";
...
export default function ErrorDiagnosticCard({
 ...
 return (
 <main className="min-h-screen w-full bg-gray-900 px-4 text-foreground transition-colors duration-300 dark:bg-slate-900 ">
 <div className="mx-auto flex min-h-screen w-full max-w-4xl items-center justify-center py-10">
 <Card className="w-full border-gray-700 bg-[#111827] shadow-lg dark:border-gray-700 dark:bg-slate-800 ">
 <CardHeader>
 <p className="text-sm font-medium text-muted-foreground">{brandingConfig.appName} Error Inspector</p>
